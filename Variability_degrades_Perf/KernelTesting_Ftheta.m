function [p_ra,p_raH,pr_aVarW,pr_aVarN]=KernelTesting_Ftheta(C,Wop,WopHom,WopVarW_fixedN, WopVarN_fixedW,classAction1,numTrials,numtrainingSamples,Y,YHomog,Y_varw_fixedN,Y_varN_fixedW)
