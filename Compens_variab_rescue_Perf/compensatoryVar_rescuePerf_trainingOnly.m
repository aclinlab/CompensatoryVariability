...
for randomTrials=1:numFlies
    ...
    Kenn_lifetimeSpar(:,randomTrials) = calcSparseness(Y_Kenn,2);
    Comp2_lifetimeSpar(:,randomTrials) = calcSparseness(Y_comp2,2);
    Comp2_wHy_lifetimeSpar(:,randomTrials) = calcSparseness(Y_comp2_wHy,2);
    ...
    Kenn_LTSpar(:,randomTrials) = nanstd(Kenn_lifetimeSpar(:,randomTrials));
    Comp2_LTSpar(:,randomTrials) = nanstd(Comp2_lifetimeSpar(:,randomTrials));
    Comp2_wHy_LTSpar(:,randomTrials) = nanstd(Comp2_wHy_lifetimeSpar(:,randomTrials));
